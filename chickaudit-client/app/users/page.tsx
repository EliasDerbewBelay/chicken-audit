...
export default function UsersPage() {
    ...
    api
      ...
      .catch((err) => {
        ...
        toast({
          ...
          description: t("Failed to load users.", language),
        });
      })
  ...
  async function handleCreateUser(e: React.FormEvent) {
    ...
    try {
      ...
      toast({
        title: t("User created", language),
        description: `${form.full_name} ${t("has been added.", language)}`,
      });
      ...
      toast({
        variant: "destructive",
        title: t("Failed to create user", language),
  ...
  async function handleResetPassword(e: React.FormEvent) {
    ...
    try {
      ...
      toast({
        ...
        description: `${t("Password for", language)} ${selectedUser.full_name} ${t("has been reset.", language)}`,
      });
      ...
      toast({
        variant: "destructive",
        title: t("Failed to reset password", language),
        description: err.message,
      });
    } finally {
      setResetting(false);
    ...
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          {t("Only owners can access this page. Redirecting...", language)}
        </p>
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <PageHeader
        ...
        subtitle={t(
          "Manage credentials reset passwords and create accounts",
          language,
        )}
      />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-card w-full max-w-md p-6 rounded-xl border border-border shadow-lg space-y-4 animate-in fade-in zoom-in duration-200">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {t("Set a new password for", language)}{" "}
